...
/**
 *  Holds all the information pertaining to reimbursements
 */
public class Reimbursements {
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm a z", timezone = "EST")
    ...
    // An absolute large amount of Setters and Getters.....
    public int getId() {
        return id;
    }
    ...
    public void setAuthorName(String authoName) {
        this.authorName = authoName;
    }

    // Equals(), HashTag(), and Stringy() methods
    @Override
